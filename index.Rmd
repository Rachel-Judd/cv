...
- <i class="fa fa-envelope"></i> rachel.judd@gmail.com
- <i class="fa fa-twitter"></i> RachelJudd
- <i class="fa fa-github"></i> github.com/Rachel-Judd
- <i class="fa fa-link"></i> [nickstrayer.me](http://nickstrayer.me/)
- <i class="fa fa-phone"></i> (555) 111-0000
...
```{r}
intro_text <- "I hope to some day make visualizations viewed by hundreds of thousands of people and build packages for R that let you do magic."

Currently searching for a program evaluation position that allows me to demonstrate impact through qualitative and quantitative data.  
"
